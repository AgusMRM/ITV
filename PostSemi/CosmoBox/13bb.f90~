program grid_mesh
        ...
        use OMP_lib
        implicit none
        integer, parameter :: cell=120, vec=10, nd=5
    ...
    !do i=1,nst
       call vecina(vec,nd,nst,pos_st,ngs,pos_gs,abin,cell,box,tot_gs,head_gs,link_gs)!,distance)
       
    !enddo
    close(12)
    ! deallocate(distance)
endprogram grid_mesh
subroutine vecina(vec,n,n1,pos1,n2,pos2,abin,cell,box,tot,head,link)!,d)
        implicit none
        integer :: i,j,k,m,cand,bxx,byy,bzz,u,p,l
        integer :: bx,by,bz,n,cell,vec,n1,n2
        real :: x0,y0,z0,x,y,z,r,abin,box,dx,dy,dz
        real,dimension(3,n1):: pos1
        real,dimension(3,n2):: pos2
        integer,dimension(n2) :: link
      !  real,dimension(n) :: d
  ...
  !$OMP cand,dist,l,x0,y0,z0,dx,dy,dz,r,r1,r2,random) &
  !$OMP SHARED (pos1,pos2,abin,tot,head,link,n,cell,vec,box,n1 )
