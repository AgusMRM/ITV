program grid_mesh
        ...
        real, parameter :: box=200, rmax=30, rmin=28! elegir el lado del box que voy a armar
 ...
 !zc=441.538681-zbox+250-150
        ...
        open(32,file='/mnt/is2/dpaz/ITV/S1373/halos/halos_50.ascii',status='unknown',action='read')
        do i=1,19
        read(32,*)
        enddo
        do i=1,halos
