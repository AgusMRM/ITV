...
! ESTE BUSCA LA DENSIDAD LOCAL DE ESTRELLAS EN EL BOX COSMOLOGICO

!       COMPILAR CON identikitBox.f90
program grid_mesh
        use modulos
        use OMP_lib
        implicit none
        integer, parameter :: cell=40, vec=5,vec2=50 ,nd=2000
        real, parameter :: box=89, rmax=10.0, rmin=0.0! elegir el lado del box que voy a armar
