...
! este es el mismo que densV.f90 pero trabaja con el box completo de 500 
! (en vez de el de 200). Es para chequear que la bimodalidad no sea
! un problema de bordes
program grid_mesh
        use modulos
        use OMP_lib
        implicit none
        integer, parameter :: cell=100, vec=5,vec2=50 ,nd=2000
        real, parameter :: box=500, rmax=10.0, rmin=0.0! elegir el lado del box que voy a armar
