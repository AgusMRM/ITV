...
program df
        ...
        open(10,file='diagfases_in.dat',status='unknown',action='write')
        open(11,file='diagfases_wall1.dat',status='unknown',action='write')
        open(12,file='diagfases_wall2.dat',status='unknown',action='write')
        open(14,file='diagfases_wall3.dat',status='unknown',action='write')
        open(15,file='diagfases_wall4.dat',status='unknown',action='write')
        open(16,file='diagfases_out.dat',status='unknown',action='write')
        call reader() 
