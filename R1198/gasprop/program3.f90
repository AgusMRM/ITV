...
!$OMP SHARED(pos_hl,vel_hl,abin,tot_td,tot_gs,tot_dm,tot_st,head_td,head_gs, &
        ...
        do i=1,halos                            
             ...
             !-----------------------------------
                ...
                if (part_dm>25) then
                        ...
                        write(10,*) x,y,z,rvir(i),np_hl(i),part_gs,part_dm,part_st,masa_st
                endif
              !  endif
        enddo
       !$OMP END DO
